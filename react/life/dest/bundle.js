...
/***/ function(module, exports, __webpack_require__) {
	...
	* */
	...
	//创建组件
	var list1 = _reactDom2.default.render(_react2.default.createElement(NotesList, { name: 'aaa' }), document.getElementById("div1"));

	var list2 = _reactDom2.default.render(_react2.default.createElement(NotesList, { name: 'bbb' }), document.getElementById("div2"));
	//更新组件
